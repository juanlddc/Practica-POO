        ...
        do{
            ...
            do{
                ...
                if(columna < 1 || columna > 7){
                    ...
                    System.out.println("Invalid column! Please enter a value between [1-7]");
                }
                if(tablero.columnaLlena(columna)){
                    //throw new ColumnaCompleta();
                    System.out.println("Invalid column! The selected column is full.");
                }
            ...
            if(victoria.haGanado(turno, tablero)){
                System.out.println(turno.getJugador() + " PLAYER WINS!");
            }
